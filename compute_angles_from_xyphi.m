function [t1 t2 t3 p1 p2 p3] = compute_angles_from_xyphi(x,y,phi,mode,geometry)
...
t1 = atan2(c1(2)-a1(2),c1(1)-a1(1));
t2 = atan2(c2(2)-a2(2),c2(1)-a2(1));
t3 = atan2(c3(2)-a3(2),c3(1)-a3(1));
p1 = atan2(b1(2)-c1(2),b1(1)-c1(1));
